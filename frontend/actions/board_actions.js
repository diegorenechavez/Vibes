...
export const fetchAllBoards = (userId) => (dispatch) =>{
    return BoardApiUtil.fetchAllBoards(userId).then((result) => dispatch(received_all_boards(result)));
};
...
export const createBoard = (board) => (dispatch) => {
  return BoardApiUtil.createBoard(board).then((result) => dispatch(received_board(result)));
